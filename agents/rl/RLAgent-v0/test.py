...
if __name__ == '__main__':
    models = [
        # ('PPO_L0_4-partners_20230803-144720_1024000-steps_ReducingNeedsReward', DictBetterObservationManager),
        ('PPO_L0_4-partners_20230803-145313_716800-steps_QuantityBasedReward', DictBetterObservationManager),
    ]
