# Greedy form of QOA. 
## Does not accept an offer from opponent unless it's at my best price and is
## at most equal to my needs.

## If opponent proposes a quantity less than or equal to my needs
## with price that's bad for me, counter with same quantity, but price that's
## best for me.
...
__all__ = ["GreedyQuantityOrientedAgent"]


class GreedyQuantityOrientedAgent(OneShotAgent):
