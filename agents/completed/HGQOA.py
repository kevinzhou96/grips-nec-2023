# Modified form of QOA to be 'smarter'. Changes are
## When it receives an offer at bad price but good quantity of at least 5,
## counter-proposal is at most half of what the opponent offered to account
## for the opponent not needing as much quantity after presumedly getting
## quantity from other agents in the mean time.

## If opponent offer was for less than 5 quantity, no longer divide by 2
## in counter-offer quantity. Just take min of 'good opp quant' and our needs
...
__all__ = ["HalfGreedyQuantityOrientedAgent"]


class HalfGreedyQuantityOrientedAgent(OneShotAgent):
